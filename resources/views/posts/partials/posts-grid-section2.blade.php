      ...
      <div class="row">
        <div class="col-md-9 order-md-2">
          ...
          <div class="d-lg-flex post-entry-2">
            <a href="single-post.html" class="mr-4 thumbnail d-inline-block mb-4 mb-lg-0">
              <img src="{{ url('storage/assets/img/post-landscape-3.jpg'); }}" alt="" class="img-fluid">
            </a>
            <div>
              ...
              <div class="d-flex align-items-center author">
                <div class="photo"><img src="{{ url('storage/assets/img/person-4.jpg'); }}" alt="" class="img-fluid"></div>
                <div class="name">
